# Generated by Powerlevel10k configuration wizard on 2019-12-17 at 21:22 PST.
...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color. Original: 255
  ...
  ##################################[ dir: current directory ]##################################
  # Default current directory color. Original: 31
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=$(xgetres color7)
  # If directory is too long, shorten some of its segments to the shortest possible unique
  # prefix. The shortened directory can be tab-completed to the original.
  typeset -g POWERLEVEL9K_SHORTEN_STRATEGY=truncate_to_unique
  # Replace removed segment suffixes with this symbol.
  typeset -g POWERLEVEL9K_SHORTEN_DELIMITER=
  # Color of the shortened directory segments. Original: 103
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=$(xgetres color7)
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor. Original: 39
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=$(xgetres color6)
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean="%$(fromhex $(xgetres color7))F"   # green foreground
  ...
  # Icon color.
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_COLOR=$(xgetres color7)
  ...
  # Powerlevel10k has to fall back to using vcs_info. Original: 76 76 178
